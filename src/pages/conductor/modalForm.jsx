...
import {
    Save, Face, Email, Phone, Directions, Replay, Fingerprint
...
const Form = ({ model = {}, handlePage, closeModal }) => {
    ...
    const onSubmit = async (e) => {
        ...
        if (img) {
            model['foto'] = img
            await save(`${URL}/conductores`, { model, reloadPage: handlePage })
        }
    }
            ...
            <Grid container direction="row" spacing={1} justify="center">
                ...
                <Grid item xs={12}>
                    <Typography
                        ...
                        {model['id'] ? 'Editar Conductor' : ' Nuevo Conductor'}
                    </Typography>
                </Grid>
                <Grid item xs={5}>
                    <CardMedia
